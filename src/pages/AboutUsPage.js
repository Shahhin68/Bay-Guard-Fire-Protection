        ...
        <div className='flex lg:items-start lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12'>
          <div className='w-full lg:w-6/12'>
            ...
            <p className='font-normal text-base leading-6 text-gray-600 mt-6'>
              We are a fire protection company that you can trust. Bay Guard
              Fire Protection. repairs, inspects, designs, installs and
              maintains fire sprinklers systems for both residential and
              commercial properties. We are locally owned &amp; operated; state
              licensed, bonded and insured company. We understand the
              complexities of fire protection.
            </p>
          </div>
          <div className='w-full lg:w-6/12'>
        ...
        <div className='flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16'>
          <div className='w-full lg:w-8/12'>
            ...
            <p className='font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12'>
              At Bay Guard Fire Protection Services, our mission is to provide
              the highest quality fire safety products and services to our
              customers. We are committed to delivering the best possible
              solutions to meet the unique needs of our customers, and to do so
              in a timely and professional manner. We strive to be the fire
              safety partner of choice for our customers, and to be a leader in
